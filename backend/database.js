...
export async function getDb() {
  ...
  await db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS orders (
      ...
      items TEXT NOT NULL,       -- JSON string of items in order
      subtotal REAL NOT NULL,
      tax REAL NOT NULL,
      shipping REAL NOT NULL,
      total REAL NOT NULL,
      paymentMethod TEXT NOT NULL,  -- COD, UPI
      paymentStatus TEXT NOT NULL,  -- Pending, Paid
      orderStatus TEXT NOT NULL,    -- Pending, Preparing, Completed, Cancelled
      customerName TEXT NOT NULL,
      customerPhone TEXT NOT NULL,
      customerAddress TEXT NOT NULL,
      timerExpiresAt TEXT,          -- ISO string representing when 15 mins is up
  ...
  if (count.count === 0) {
    ...
    const initialProducts = [
      {
        ...
        ingredients: JSON.stringify(['Dutch Cocoa Powder', 'Belgian Chocolate Chunks', 'Organic Oat Milk', 'Brown Sugar Cane', 'Gourmet Whipped Cream']),
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Organic Wheat Flour', 'Madagascar Vanilla Extract', 'Fresh Mint Leaves', 'Swiss Meringue Buttercream', 'Sugar Pearls']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Wild Organic Blueberries', 'Unsweetened Almond Milk', 'Raw Clover Honey', 'Chia Seeds', 'Greek Vanilla Yogurt']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Wheat Flour Blend', 'Active Yeast', 'Strawberry Nectar Glaze', 'Rainbow Sugar Sprinkles', 'Vanilla Extract']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Stone Ground Flour', 'French Normandy Butter', 'Dry Active Yeast', 'Sea Salt', 'Organic Sugar Cane']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Cake Flour', 'Premium Cocoa Powder', 'Cream Cheese', 'Organic Buttermilk', 'Vanilla Extract']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Almond Flour', 'Egg Whites', 'Powdered Sugar', 'Roasted Pistachios', 'White Chocolate']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Pastry Flour', 'Yeast Batter', 'Fresh Strawberries', 'Pure Maple Syrup', 'Double Cream']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['French Wheat Flour', 'Cultured Butter', 'Dark Belgian Chocolate', 'Raw Cocoa Powder', 'Yeast']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Enriched Wheat Flour', 'Milk Chocolate Glaze', 'Rainbow Sprinkles', 'Butter', 'Whole Milk']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        category: 'Gourmet Cupcake',
        price: 4.25,
        stock: 0, // start out of stock for testing
        ...
        ingredients: JSON.stringify(['Cake Flour', 'Tahitian Vanilla Bean', 'Custard Cream', 'Organic Eggs', 'Sugar Pearls']),
        nutrition: JSON.stringify([
          { name: 'Carbs', percentage: 68 },
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Yeast Batter', 'Fresh Blackberries', 'Strawberries', 'Vanilla Ice Cream', 'Berry Purée']),
        nutrition: JSON.stringify([
          { name: 'Carbs', percentage: 65 },
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Almond Flour', 'Egg Whites', 'Salted Butter Caramel', 'Fleur de Sel', 'Brown Sugar']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Wheat Flour', 'Uji Matcha Powder', 'Powdered Sugar', 'Butter Milk', 'White Chocolate Drizzle']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Roasted Hazelnut Paste', 'Creamy Milk', 'Vanilla Ice Cream', 'Chocolate Ganache', 'Crushed Praline']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Sable Pastry Crust', 'Fresh Lemon Juice & Zest', 'Egg Yolks', 'Toasted Italian Meringue', 'Vanilla Extract']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['French Croissant', 'Almond Flour', 'Unsalted Butter', 'Flaked Almonds', 'Powdered Sugar Dust']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Cake Flour', 'Raspberry Jam Pocket', 'Pink Raspberry Buttercream', 'Fresh Berries', 'Vanilla Paste']),
        nutrition: JSON.stringify([
          { name: 'Carbs', percentage: 70 },
          { name: 'Fats', percentage: 38 },
          { name: 'Proteins', percentage: 12 },
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Alfonso Mango Pulp', 'Passion Fruit Syrup', 'Fresh Milk', 'Vanilla Ice Cream', 'Double Cream Whipped']),
        nutrition: JSON.stringify([
          { name: 'Carbs', percentage: 65 },
          { name: 'Fats', percentage: 22 },
          { name: 'Proteins', percentage: 18 },
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Almond Flour', 'Egg Whites', 'Blueberry Compote', 'White Chocolate Ganache', 'Natural Blue Extract']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Yeast Dough', 'Ceylon Cinnamon', 'Dark Brown Sugar', 'Cream Cheese Frosting', 'Cultured Butter']),
        nutrition: JSON.stringify([
          { name: 'Carbs', percentage: 70 },
          { name: 'Fats', percentage: 48 },
          { name: 'Proteins', percentage: 14 },
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Velvet Cake Flour', 'Rose Water Syrup', 'Vanilla Cream Petals', 'Sugar Pearls', 'Organic Butter']),
        nutrition: JSON.stringify([
          { name: 'Carbs', percentage: 70 },
          { name: 'Fats', percentage: 40 },
          { name: 'Proteins', percentage: 14 },
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Stone Ground Flour', 'Uji Matcha Powder', 'Whipped Cream', 'Sweet Red Bean', 'Organic Honey']),
        nutrition: JSON.stringify([
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Belgian Cocoa Liquor', 'Brown Butter', 'Gourmet Sugar Cane', 'Fresh Farm Eggs', 'Vanilla Bean Powder']),
        nutrition: JSON.stringify([
          { name: 'Carbs', percentage: 62 },
      ...
      },
      {
        ...
        ingredients: JSON.stringify(['Sicilian Pistachio Gelato', 'Organic Oat Milk', 'Whipped Double Cream', 'Caramel Praline Crumbles', 'Raw Honey']),
        nutrition: JSON.stringify([
          { name: 'Carbs', percentage: 52 },
          { name: 'Fats', percentage: 48 },
          { name: 'Proteins', percentage: 24 },
    ...
    for (const p of initialProducts) {
      await stmt.run(
        p.id, p.title, p.category, p.price, p.stock, p.description, p.src, p.alt, p.bg, p.themeColor, p.accentColor, p.textColor, p.specs, p.ingredients, p.nutrition, p.bgText
      );
    }
    await stmt.finalize();
